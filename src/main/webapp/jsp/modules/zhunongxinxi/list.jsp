...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">助农信息管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>助农信息列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('tixingbiaoti')">提醒标题<i id="tixingbiaotiIcon" class="fa fa-sort"></i></th>
						<th>图片</th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var tixingbiaotiCell  = document.createElement('td');

						 tixingbiaotiCell.innerHTML = item.tixingbiaoti;

			row.appendChild(tixingbiaotiCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("zhunongxinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"zhunongxinxi");
