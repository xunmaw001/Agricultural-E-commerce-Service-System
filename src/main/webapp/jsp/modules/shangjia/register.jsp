...
<body>
	...
	<div class="content">
			<form id="registerForm" action="" method="post">
				...
				<div class="list-item">
					<div class="item-label">商家账号</div> 
					<input  id="shangjiazhanghao" name="shangjiazhanghao"  placeholder="请输入商家账号" class="form-control-i">
				</div>
				<div class="list-item">
				...
				<div class="list-item">
					...
					<input  id="dianpumingcheng" name="dianpumingcheng"  placeholder="请输入店铺名称" class="form-control-i">
				</div>
				<div class="list-item">
