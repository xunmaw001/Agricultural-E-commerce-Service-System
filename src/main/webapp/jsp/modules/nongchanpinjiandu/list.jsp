...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">农产品监督管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>农产品监督列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th>图片</th>
						<th onclick="sort('wendu')">温度<i id="wenduIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var wenduCell  = document.createElement('td');

						 wenduCell.innerHTML = item.wendu;

			row.appendChild(wenduCell);
			...
			var shengzhanghuanjingCell  = document.createElement('td');

						  var shengzhanghuanjingMedia = document.createElement('button');
			  shengzhanghuanjingMedia.setAttribute('class','btn-table')
			  shengzhanghuanjingMedia.innerHTML = '播放';
			  var shengzhanghuanjingAttr = "mediaPlay('" + baseUrl+ item.shengzhanghuanjing + "')"
			  shengzhanghuanjingMedia.setAttribute('onclick',shengzhanghuanjingAttr);
       		          shengzhanghuanjingCell.appendChild(shengzhanghuanjingMedia);


			row.appendChild(shengzhanghuanjingCell);
			var wuliuzhuangkuangCell  = document.createElement('td');
		...
		function sh(){
			...
			httpJson("nongchanpinjiandu/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("nongchanpinjiandu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"nongchanpinjiandu");
