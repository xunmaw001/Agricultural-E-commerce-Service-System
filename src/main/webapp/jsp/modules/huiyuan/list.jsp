...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">会员管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>会员管理</span></li>
				<li class="breadcrumb-item-two"><span>会员列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				<div class="form-item">
					<label>会员账号</label>
					<input type="text" id="huiyuanzhanghaoSearch" class="form-control form-control-sm" placeholder="请输入会员账号" aria-controls="tableId">
				</div>
				<div class="form-item">
					<label>会员姓名</label>
					<input type="text" id="huiyuanxingmingSearch" class="form-control form-control-sm" placeholder="请输入会员姓名" aria-controls="tableId">
				</div>
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('huiyuanzhanghao')">会员账号<i id="huiyuanzhanghaoIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#huiyuanzhanghaoSearch').val() != null && $('#huiyuanzhanghaoSearch').val() != ''){
				searchForm.huiyuanzhanghao ="%" +  $('#huiyuanzhanghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("huiyuan/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				huiyuanzhanghao : searchForm.huiyuanzhanghao,	
		...
		function setDataRow(item,number){
			...
			var huiyuanzhanghaoCell  = document.createElement('td');

						 huiyuanzhanghaoCell.innerHTML = item.huiyuanzhanghao;

			row.appendChild(huiyuanzhanghaoCell);
