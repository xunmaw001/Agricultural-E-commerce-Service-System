	...
	<div class="content">
			<form id="registerForm" action="" method="post">
				...
				<div class="list-item">
					...
					<input  id="huiyuanzhanghao" name="huiyuanzhanghao"  placeholder="请输入会员账号" class="form-control-i">
				</div>
				<div class="list-item">
				...
				<div class="list-item">
					...
					<input  id="huiyuanxingming" name="huiyuanxingming"  placeholder="请输入会员姓名" class="form-control-i">
				</div>
                <div class="list-item">
				...
				<div class="list-item">
					...
					<input  id="shoujihao" name="shoujihao"  placeholder="请输入手机号" class="form-control-i">
				</div>
