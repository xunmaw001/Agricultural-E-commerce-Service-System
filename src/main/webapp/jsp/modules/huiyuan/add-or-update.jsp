...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑会员</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑会员</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>会员账号</label>
					<input name="huiyuanzhanghao" id="huiyuanzhanghao" name="huiyuanzhanghao" class="form-control" placeholder="请输入会员账号">
				</div>
				<div class="form-item">
					<label>密码</label>
				...
				<div class="form-item">
					<label>会员姓名</label>
					<input name="huiyuanxingming" id="huiyuanxingming" name="huiyuanxingming" class="form-control" placeholder="请输入会员姓名">
				</div>
				<div class="form-item">
					<label>性别</label>
				...
				<div class="form-item">
					<label>手机号</label>
					<input name="shoujihao" id="shoujihao" name="shoujihao" class="form-control" placeholder="请输入手机号">
				</div>
	...
	<script>
		...
		function dataBind(){
			...
			$("#huiyuanzhanghao").val(ruleForm.huiyuanzhanghao);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.huiyuanzhanghao != null && res.data.huiyuanzhanghao != ''){

						$("#huiyuanzhanghao").val(res.data.huiyuanzhanghao);
						$("#huiyuanzhanghao").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.huiyuanxingming != null && res.data.huiyuanxingming != ''){
						...
						$("#huiyuanxingming").attr('readonly','readonly');
					}
