...
<style>
	#home-container {
				padding: 30px;
				background: url(http://codegen.caihongy.cn/20230401/bd196cf1072f48afae5676066a72e297.jpg) fixed no-repeat center top / 100% 100%;
				min-height: 100vh;
				height: 100%;
			}
...
<body>
	<div id="main-container">
		...
		<div id="home-container">
			<div class="home-container-title">欢迎使用&nbsp;农业电商服务系统</div>
