		...
		<div id="app">
			...
			<div class="data-add-container" :style='{"width":"100%","padding":"120px 7% 100px","margin":"0px auto","position":"relative","background":"url(http://codegen.caihongy.cn/20230109/138a4d606eae4a168810cef229969885.png) no-repeat center top,url(http://codegen.caihongy.cn/20230109/b95aeae1c1294f398aefb7c6cd5b16de.png) no-repeat center top,url(http://codegen.caihongy.cn/20230109/5ffc803e6682418eb7f0b09a98e35527.png) no-repeat center bottom,#faf0e6"}'>
				<form class="layui-form layui-form-pane add" lay-filter="myForm">
					...
					<div :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#efe4d4","alignItems":"center","borderWidth":"0 0 2px","background":"none","display":"flex","borderStyle":"solid"}' class="layui-form-item">
						<div :style='{"width":"120px","padding":"0 15px","lineHeight":"40px","fontSize":"18px","textAlign":"right","fontWeight":"600"}' class="label">提醒标题：</div>
						<input :style='{"padding":"0 10px","margin":"0","borderColor":"#e5d9c6","color":"#333","outline":"none","borderRadius":"4px","borderWidth":"1px","background":"#fff","width":"360px","fontSize":"16px","lineHeight":"40px","borderStyle":"solid","height":"40px"}' v-model="detail.tixingbiaoti" type="text" :readonly="ro.tixingbiaoti" name="tixingbiaoti" id="tixingbiaoti" autocomplete="off" class="layui-input">
					</div>
					<div :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#efe4d4","alignItems":"center","borderWidth":"0 0 2px","background":"none","display":"flex","borderStyle":"solid"}' class="layui-form-item">
					...
					<div :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#efe4d4","alignItems":"center","borderWidth":"0 0 2px","background":"none","display":"flex","borderStyle":"solid"}' class="layui-form-item">
						<div :style='{"width":"120px","padding":"0 15px","lineHeight":"40px","fontSize":"18px","textAlign":"right","fontWeight":"600"}' class="label">提醒时间：</div>
						<input :style='{"padding":"0 10px","margin":"0","borderColor":"#e5d9c6","color":"#333","outline":"none","borderRadius":"4px","borderWidth":"1px","background":"#fff","width":"360px","fontSize":"14px","lineHeight":"40px","borderStyle":"solid","height":"40px"}' type="text" name="tixingshijian" id="tixingshijian" autocomplete="off" class="layui-input" >
					</div>

					<div :style='{"alignItems":"center","margin":"0 0 10px 0","display":"flex"}' class="layui-form-item">
						<div :style='{"width":"120px","padding":"0 15px","lineHeight":"44px","fontSize":"18px","textAlign":"right","fontWeight":"600"}' class="label">提醒内容：</div>
						<textarea :style='{"padding":"0","boxShadow":"0 0 0px rgba(75,223,201,.5)","margin":"20px 0 20px","borderColor":"#efe4d4","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2px","width":"100%","borderStyle":"solid","height":"auto"}' name="tixingneirong" id="tixingneirong">请输入提醒内容</textarea>
					</div>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				form.on('select(shangjiazhanghao)', (data) => {
					...
					http.request('follow/shangjia/shangjiazhanghao', 'get', {
						...
						vue.detail.shangjiazhanghao=res.data.shangjiazhanghao
						vue.detail.dianpumingcheng=res.data.dianpumingcheng
					})
				});
				// 上传图片
				...
				http.request(`option/shangpinfenlei/shangpinfenlei`,'get',{},(res)=>{
					vue.shangpinfenlei = res.data
                                ...
                                jquery('#tixingshijian').val(getCurDateTime());
				laydate.render({
					elem: '#tixingshijian',
					type: 'datetime'
				});
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
					var tixingneirong = tinymce.get('#tixingneirong').getContent()
					data.tixingneirong = tixingneirong;
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('zhunongxinxi/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 提交数据
                                            http.requestJson('zhunongxinxi' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
