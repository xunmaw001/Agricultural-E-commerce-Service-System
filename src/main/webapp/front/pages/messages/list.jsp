			...
			<div class="forum-container">
				<form :style='{"boxShadow":"0 0px 0px 0 rgba(0, 0, 0, .1)","padding":"15px","margin":"0 0 20px","borderColor":"#fff","borderWidth":"0px","background":"none","width":"100%","borderStyle":"dotted"}' class="layui-form message-form">
					<div :style='{"width":"100%","display":"flex","height":"auto"}' class="layui-form-item layui-form-text">
						<label :style='{"width":"80px","padding":"0 10px 0 0","lineHeight":"40px","fontSize":"18px","color":"#666","textAlign":"right"}' class="layui-form-label">留言</label>
					...
					<div :style='{"width":"100%","display":"flex","height":"auto"}' class="layui-form-item layui-form-text">
						<label :style='{"width":"80px","padding":"0 10px 0 0","lineHeight":"40px","fontSize":"18px","color":"#666","textAlign":"right"}' class="layui-form-label">图片</label>
						<div v-if="cpicture">
				...
				<div :style='{"boxShadow":"0 0px 0px 0 rgba(0, 0, 0, .1)","padding":"15px","borderColor":"#fff","borderWidth":"0px","background":"none","width":"100%","borderStyle":"groove"}' class="message-list" v-if="dataList.length">
					<div :style='{"padding":"10px","boxShadow":"inset 0px 0px 0px 0px #c5f1c0","margin":"0 0 20px","borderColor":"#eee","alignItems":"center","borderWidth":"0px","width":"100%","borderStyle":"solid","height":"auto"}' class="message-item" v-for="(item,index) in dataList" v-bind:key="index" >
						<div :style='{"padding":"6px 0","borderColor":"#eee","alignItems":"center","borderWidth":"0 0 1px","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="username-container">
							...
							<div :style='{"color":"#333","fontSize":"18px"}' class="username">{{item.username}}</div>
						</div>
						...
						<div v-if="item.cpicture">
							<img style="width: 600px; max-width: 100%; margin-top: 8px;" :src="baseurl+item.cpicture">
						</div>
						<div :style='{"padding":"8px","boxShadow":"rgb(75 223 201 / 30%) 0px 0px 0px","margin":"10px 0px 0px","borderColor":"#c7eec2","color":"#333","borderRadius":"0px","background":"none","borderWidth":"0px","lineHeight":"30px","fontSize":"16px","borderStyle":"solid","textIndent":"2em"}' v-if="item.reply" class="replay">
							回复：{{item.reply}}
						</div>
						<div v-if="item.rpicture">
							<img style="width: 200px; max-width: 100%; margin-top: 8px;" :src="baseurl+item.rpicture">
						</div>
					</div>
				</div>
