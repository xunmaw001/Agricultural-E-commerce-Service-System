...
<html>
	...
	<body>
	<div id="apps">
		<div id="header" :style='{"boxShadow":"0 0px 0px rgba(90, 180, 80, .2)","padding":"0px","alignItems":"center","display":"flex","right":"0","justifyContent":"space-between","overflow":"hidden","top":"0","left":"0","background":"#434343","position":"fixed","height":"44px","zIndex":"1002"}'>
			...
			<div v-if="projectName" :style='{"margin":"0 0 0 210px","color":"#e4e4e4","textAlign":"center","background":"none","width":"calc(100% - 370px)","lineHeight":"44px","fontSize":"24px","fontWeight":"500","height":"44px"}' class="nav-top-title">{{projectName}}</div>
			<div :style='{"width":"180px","margin":"0 20px 0 0","alignItems":"center","display":"flex"}'>
				...
				<button v-if="!Token" :style='{"border":"0px solid #bdefb6","cursor":"pointer","padding":"0 20px","boxShadow":"inset 0px 0px 0px 0px #c5f1c0","margin":"0 0 0 10px","color":"#333","borderRadius":"2px","background":"#e0be8d","display":"inline-block","fontSize":"14px","lineHeight":"32px","height":"32px"}' @click="jumpLogin('./pages/login/login.jsp')">登录/注册</button>
				<button v-if="Token" :style='{"border":"0px solid #ddd","cursor":"pointer","padding":"0 20px","boxShadow":"inset 0px 0px 0px 0px #eee","margin":"0 0 0 10px","color":"#666","borderRadius":"2px","background":"#fff","display":"inline-block","fontSize":"14px","lineHeight":"32px","height":"32px"}' @click="logout()">退出</button>
			</div>
		</div>
		
		
		<!-- 横向 -->
		<div id="navs" class="horizontal" :style='{"padding":"0","margin":"44px 0px 0px","background":"none","width":"100%","position":"fixed","height":"80px","zIndex":"999"}'>
			<ul class="layui-nav" lay-bar="disabled" :style='{"border":0,"padding":"0","listStyle":"none","margin":"0","borderColor":"#249940","textAlign":"center","background":"rgba(0,0,0,.5)","borderWidth":"0 0 0px","position":"relative","borderStyle":"solid","height":"100%"}'>
		...
		<div id="tabbar" class="tabbar" :style='{"minHeight":"150px","padding":"20px 0","borderColor":"#cfa66a","alignItems":"center","background":"#2c2c2c","flexDirection":"column","borderWidth":"0px 0 0","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"center"}'>
